---
name: "create-skill"
description: "Wizard for creating new Project Zero skills. Guides users through creating well-structured SKILL.md files. Use when users want to create custom skills."
version: "1.0.0"
...
This skill helps you create new Project Zero skills that follow the SKILL.md standard.
