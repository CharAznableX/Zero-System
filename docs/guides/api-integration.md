...
One of Project Zero's most powerful capabilities is the ability to integrate external APIs on the fly without writing any code. By simply providing API documentation or code snippets, the agent can learn to use new services and remember how to use them in future conversations.
...
### Step 2: Provide the Code to Project Zero

Now we'll tell Project Zero to use this code:

1. Open a chat with Project Zero
2. Send a message like: **"Use this code to generate an image of the Project Zero logo"**
3. Either:
   - Attach the downloaded Python file, or
   - Paste the code snippet into the chat

Project Zero will analyze the code and understand:
- What dependencies are needed (`google-genai` package)
- How to structure the API request
- What parameters are required
- How to handle the response

![Project Zero analyzing the API code](../res/usage/api-int/api-int-2image-gen-api2.png)

### Step 3: Configure API Credentials

On first run, Project Zero will attempt to use the API but discover it needs an API key:

![Missing API key error](../res/usage/api-int/api-int-3-api-key-missing-secrets.png)

Project Zero will tell you:
...
After configuring the API key, tell Project Zero to proceed:
...
The agent confirms:
- Mission complete
- File location: `/root/project_zero_logo_0.jpg`
- File size: 378 KB

## How Memory Works

Here's where it gets interesting: **Project Zero will remember this solution**.
...
For APIs you use frequently, you can have Project Zero create reusable wrapper functions:
...
By leveraging Project Zero's ability to learn from API code snippets, you can:
...
This makes Project Zero incredibly versatile - it's not limited to its built-in features. Show it how to use an API once, and it becomes part of its permanent toolkit.
