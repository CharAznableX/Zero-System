...
Projects are one of Project Zero's most powerful features for organizing your work. They create isolated workspaces with dedicated context, instructions, memory, and secrets - preventing context bleed between unrelated tasks or clients.

This tutorial will guide you through creating, configuring, and using projects effectively.

## What Are Projects?

A project in Project Zero is an isolated workspace that includes:
...
Project Zero's **Git Projects** feature allows you to clone repositories directly into your project workspace:
...
3. Project Zero will clone the repository
...
> [!NOTE]
> If the cloned repository already contains a `.a0proj/` folder with `project.json`, Project Zero will merge the existing configuration with your specified title and color preferences.
...
Projects work exceptionally well with Project Zero's **Tasks & Scheduling** feature:
