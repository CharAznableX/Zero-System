# Contributing Skills to Project Zero

Welcome to the Project Zero Skills ecosystem! This guide will help you create, test, and share skills with the community.
...
2. **Test Semantic Recall:**
   Start Project Zero and ask questions that should trigger your skill.
...
1. **Fork the Repository:**
   ```bash
   git clone https://github.com/CharAznableX/project-zero.git
   cd project-zero
   ```
