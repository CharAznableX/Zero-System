...
def print_troubleshooting():
    ...
    print("   - Make sure Project Zero is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Project Zero server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Project Zero server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Project Zero server if not running")
